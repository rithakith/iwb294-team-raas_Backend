...
service /api on new http:Listener(8083) {
  ...
  @http:ResourceConfig {
    cors: {
        allowOrigins: ["http://192.168.43.52:8081", "http://localhost:8081", "https://fe31-2407-c00-c001-c892-dd89-2bb4-6f71-562a.ngrok-free.app","https://4898-2407-c00-c001-c892-25a7-98b5-4d7c-b5a3.ngrok-free.app"], // Include your phone's IP
        allowMethods: ["GET", "POST", "PUT", "DELETE"],
        allowHeaders: ["Authorization", "Content-Type"],
        exposeHeaders: [],
        allowCredentials: true,
